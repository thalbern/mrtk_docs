...
function createDropdown()
{
	...
	var googleRef = document.createElement('script');
	googleRef.src = "//translate.google.com/translate_a/element.js?cb=googleTranslateElementInit";
	document.head.appendChild(googleRef);
}
